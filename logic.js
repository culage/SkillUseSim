...
var App, CookieAccess, DataAccess, EventDispatcher, LastElementKeeper, Mons, MonsSwapper, MonsView, Team, ValueStorage, ValueStorageListView, mixin,
...
App = (function() {
  ...
  App.prototype.initSaveLoad = function() {
    ...
    this.vs = new ValueStorage(ids, new CookieAccess());
    ...
    return document.getElementById("btnDel").onclick = (function(_this) {
      return function() {
...
ValueStorage = (function() {
  ...
  ValueStorage.prototype.load = function(dataIdx) {
    ...
    for (id in datas) {
      value = datas[id];
      results.push(document.getElementById(id).value = value);
    }
    return results;
  };
